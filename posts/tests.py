...
class ModelsTestCase(unittest.TestCase):
    def setUp(self):
        User.objects.create_user(username="usernametest1", password="passwordtest1", email="emailtest1@gmail.com")
        User.objects.create_user(username="usernametest2", password="passwordtest2", email="emailtest2@gmail.com")
